...
/*/ Устанавливаем обработчик события на каждую кнопку "удалить из корзины"
for (var i = 0; i < itemBox.length; i--) {
  addEvent(itemBox[i].querySelector('.add_item'), 'click', addToCartMinus);
}*/
...
function openCart(e) {
  ...
  if (cartData !== null) {
    ...
    totalItems += '</table>';
    //totalItems += '<button class="next">Далее...</button>';
